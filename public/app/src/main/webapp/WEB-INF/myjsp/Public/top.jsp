        ...
        <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
            ...
            <form id="topbar-search" action="#" method="GET" class="hidden-xs">
                <div class="input-group">
                    <input type="text" placeholder="Search..." class="form-control"><span class="input-group-btn"><a
                        href="javascript:;" class="btn submit"><i class="fa fa-search"></i></a></span>
                </div>
            </form>
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <div class="slimScrollDiv"
                                ...
                                <div class="dropdown-slimscroll" style="overflow: hidden; width: auto; height: 250px;">
                                    <ul>
                                        ...
                                        <li><a href="extra-user-list.html" target="_blank"><span
                                                class="label label-green"><i class="fa fa-tasks"></i></span>New
                                            Task<span class="pull-right text-muted small">2 days ago</span></a>
                                        </li>
                                        <li><a href="extra-user-list.html" target="_blank"><span
                                                class="label label-pink"><i class="fa fa-envelope"></i></span>Message
                                            Sent<span class="pull-right text-muted small">5 days ago</span></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown-slimscroll" style="overflow: hidden; width: auto; height: 250px;">
                                    <ul>
                                        <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img
                                                src="/images/48.jpg"
                                                alt="" class="img-responsive img-circle"></span><span class="info"><span
                                                class="name">Jessica Spencer</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                        </li>
                                        <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img
                                                src="/images/48.jpg"
                                                alt="" class="img-responsive img-circle"></span><span class="info"><span
                                                class="name">John Smith<span
                                                class="label label-blue pull-right">New</span></span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                        </li>
                                        <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img
                                                src="/images/48.jpg"
                                                alt="" class="img-responsive img-circle"></span><span class="info"><span
                                                class="name">John Doe<span
                                        ...
                                        <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img
                                                src="/images/48.jpg"
                                                alt="" class="img-responsive img-circle"></span><span class="info"><span
                                                class="name">John Smith</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                        </li>
                                        <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img
                                                src="/images/48.jpg"
                                                alt="" class="img-responsive img-circle"></span><span class="info"><span
                    ...
                    <ul class="dropdown-menu dropdown-theme-setting pull-right">
                        ...
                        <li>
                            ...
                            <ul id="list-color" class="list-unstyled list-inline">
                                <li data-color="green-dark" data-hover="tooltip" title="" class="green-dark"
                                    data-original-title="Green - Dark"></li>
                                <li data-color="red-dark" data-hover="tooltip" title="" class="red-dark"
                                    data-original-title="Red - Dark"></li>
                                <li data-color="pink-dark" data-hover="tooltip" title="" class="pink-dark"
                                    data-original-title="Pink - Dark"></li>
                                <li data-color="blue-dark" data-hover="tooltip" title="" class="blue-dark"
                                    data-original-title="Blue - Dark"></li>
                                <li data-color="yellow-dark" data-hover="tooltip" title="" class="yellow-dark"
                                    data-original-title="Yellow - Dark"></li>
                                <li data-color="green-grey" data-hover="tooltip" title="" class="green-grey"
                                    data-original-title="Green - Grey"></li>
                                <li data-color="red-grey" data-hover="tooltip" title="" class="red-grey"
                                    data-original-title="Red - Grey"></li>
                                <li data-color="pink-grey" data-hover="tooltip" title="" class="pink-grey"
                                    data-original-title="Pink - Grey"></li>
                                <li data-color="blue-grey" data-hover="tooltip" title="" class="blue-grey"
                                    data-original-title="Blue - Grey"></li>
                                <li data-color="yellow-grey" data-hover="tooltip" title="" class="yellow-grey"
                                    data-original-title="Yellow - Grey"></li>
                                <li data-color="yellow-green" data-hover="tooltip" title="" class="yellow-green"
                                    data-original-title="Yellow - Green"></li>
                                <li data-color="orange-grey" data-hover="tooltip" title="" class="orange-grey"
                                    data-original-title="Orange - Grey"></li>
                                <li data-color="pink-blue" data-hover="tooltip" title="" class="pink-blue"
                                    data-original-title="Pink - Blue"></li>
                                <li data-color="pink-violet" data-hover="tooltip" title="" class="pink-violet active"
                                    data-original-title="Pink - Violet"></li>
                                <li data-color="orange-violet" data-hover="tooltip" title="" class="orange-violet"
                                    data-original-title="Orange - Violet"></li>
                                <li data-color="pink-green" data-hover="tooltip" title="" class="pink-green"
                                    data-original-title="Pink - Green"></li>
                                <li data-color="pink-brown" data-hover="tooltip" title="" class="pink-brown"
                                    data-original-title="Pink - Brown"></li>
                                <li data-color="orange-blue" data-hover="tooltip" title="" class="orange-blue"
                                    data-original-title="Orange - Blue"></li>
                                <li data-color="yellow-blue" data-hover="tooltip" title="" class="yellow-blue"
                                    data-original-title="Yellow - Blue"></li>
                                <li data-color="green-blue" data-hover="tooltip" title="" class="green-blue"
                                    data-original-title="Green - Blue"></li>
                            </ul>
                        </li>
                    </ul>
                    <!--END THEME SETTING-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eleifend et nisl eget porta.
                        Curabitur elementum sem molestie nisl varius, eget tempus odio molestie. Nunc vehicula sem arcu,
                        eu pulvinar neque cursus ac. Aliquam ultricies lobortis magna et aliquam. Vestibulum egestas eu
                        urna sed ultricies. Nullam pulvinar dolor vitae quam dictum condimentum. Integer a sodales elit,
                        eu pulvinar leo. Nunc nec aliquam nisi, a mollis neque. Ut vel felis quis tellus hendrerit
                        placerat. Vivamus vel nisl non magna feugiat dignissim sed ut nibh. Nulla elementum, est a
                        pretium hendrerit, arcu risus luctus augue, mattis aliquet orci ligula eget massa. Sed ut
                        ultricies felis.</p>
                </div>
